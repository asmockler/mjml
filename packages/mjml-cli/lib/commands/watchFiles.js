...
var flatMapKeyAndValues = (0, _fp.flow)(_flatMap(function (v, k) {
  return [k].concat(_toConsumableArray(v));
}), _fp.uniq);
...
exports.default = function (input, options) {
  ...
  var readAndCompile = (0, _fp.flow)(function (file) {
    ...
    return _extends({}, args, {
      compiled: (0, _mjmlCore2.default)(args.content, _extends({
        filePath: args.file
      }, options.config))
    });
  }, function (args) {
    ...
    (_console = console).warn.apply(_console, [errors].concat(_toConsumableArray(errors.map(function (e) {
